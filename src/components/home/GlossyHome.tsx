            ...
            <div className="container-wide px-6 pb-8 sm:pb-12">
              <div className="max-w-3xl text-white">
                ...
                <Link href={`/posts/${lead.slug}`}>
                  <h2 className="display mt-3 line-clamp-3 text-4xl font-black leading-[1.02] text-white [text-shadow:0_1px_16px_rgba(0,0,0,0.45)] sm:text-5xl md:text-6xl">
                    {lead.title}
                  </h2>
                </Link>
                {lead.dek && (
                  <p className="mt-3 max-w-xl text-lg text-white/85 excerpt-clamp-3">
                    {lead.dek}
                  </p>
                )}
              </div>
